  ...
  return (
        <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
              ...
              <div className="relative z-10 flex flex-col items-center w-full px-4" style={{ maxWidth: 420 }}>
                      <div className="bg-white w-full flex flex-col items-center px-10 py-10 gap-5"
                                ...
                                <div className="text-center">
                                            <h1 className="font-bold tracking-tight mb-1" style={{ color: "#1a3a5c", fontSize: 18 }}>
                                                          Sistema de Gestion de Equipo Vitales - Corporacion municipal panguipulli
                                            </h1>h1>
                                            <p className="text-gray-500 text-sm">sistema para calidad y seguridad del paciente</p>p>
                                </div>div>
                                <div className="w-full h-px bg-gray-100" />
                                <div className="text-center">
                                            <h2 className="text-gray-700 text-base font-medium">Bienvenido/a</h2>h2>
                                            <p className="text-gray-400 text-sm mt-0.5">Inicia sesión para acceder al sistema</p>p>
                                </div>div>
                      ...
                      <p className="mt-6 text-center" style={{ color: "rgba(147,197,253,0.7)", fontSize: 12 }}>
                                Elaborado por Departamento de informatica - Corporación Municipal Panguipulli © 2026
                      </p>p>
              </div>div>
        </div>div>
      );
