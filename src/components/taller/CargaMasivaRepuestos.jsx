...
export default function CargaMasivaRepuestos({ open, onClose, onComplete, proveedores }) {
  ...
  const descargarPlantilla = () => {
    ...
    const ejemplo = ["Filtro de aceite", "F-001", "filtros", "Toyota Hilux", "10", "3", "12000", "Repuestos Chile", "Estante A-1", "F-2024-001", "2026-01-15", "OC-456", "2026-01-10", "Repuesto de prueba"].join(",");
    const csv = headers + "\n" + ejemplo;
    const blob = new Blob(["\ufeff" + csv], { type: "text/csv;charset=utf-8;" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url; a.download = "plantilla_repuestos.csv"; a.click();
