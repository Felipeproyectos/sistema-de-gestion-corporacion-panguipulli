  ...
  return (
    <div className="bg-white rounded-2xl p-4 transition-all" style={{ border: `1px solid ${stockBajo ? "#FECACA" : "#E2E8F0"}`, boxShadow: "0 2px 8px rgba(15,45,107,0.05)" }}>
      ...
      <div className="flex gap-2 mt-2">
        ...
        {confirmDelete ? (
          <>
            <button onClick={() => base44.entities.Repuesto.delete(repuesto.id).then(onCambioStock)} className="flex-1 py-2 rounded-xl text-xs font-bold text-white" style={{ background: "#DC2626" }}>Confirmar</button>
