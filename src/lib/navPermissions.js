...
export const NAV_ITEMS = [
  ...
  { label: "Equipos", page: "Equipos2", path: "/Equipos2", icon: Monitor,
    roles: ["admin", "super_admin", "monitor_corporativo", "admin_salud", "supervisor", "operador", "user"] },
  ...
  { label: "Reportes", page: "Reportes", path: "/Reportes", icon: FileText,
    roles: ["admin", "super_admin", "monitor_corporativo", "admin_salud", "jefe_taller", "supervisor"] },
